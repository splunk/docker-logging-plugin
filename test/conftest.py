...
def pytest_addoption(parser):
    parser.addoption("--splunkd-url", help="splunkd url used to send test data to. Eg: https://localhost:8089", default="https://52.53.254.149:8089")
    parser.addoption("--splunk-user", help="splunk username", default="admin")
    parser.addoption("--splunk-password", help="splunk user password", default="notchangeme")
    parser.addoption("--docker-plugin-path", help="docker plugin binary path", default="/home/ec2-user/plugin/splunk-log-plugin")
    parser.addoption("--fifo-path", help="full file path to the fifo", default="/home/ec2-user/pipe")
