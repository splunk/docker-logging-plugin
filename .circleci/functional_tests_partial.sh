...
tests=( "test_partial_log_1" "test_partial_log_2" "test_partial_log_flush_timeout_1" "test_partial_log_flush_timeout_2" "test_partial_log_flush_size_limit" )
for i in "${tests[@]}"
do
    sudo venv/bin/python -m pytest --cache-clear \
        ...
        -p no:warnings partial_log/test_partial_log.py::${tests[i]}
done
